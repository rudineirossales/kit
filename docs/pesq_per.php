...
if ($_SESSION['acesso'] == 'ADM')
{
  ...
  $sql = mysql_query ("SELECT * FROM colaborador group by nome_ga" );
}
else
{
...
<td> <a style="color:black;" href="table-data-table2.php?id=<?php echo $dado ["id_ga"]; ?>" target="_blank"  role="button" aria-pressed="true"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
<?php } else { ?>



<td> <a style="color:black;" href="table-data-table.php?id=<?php echo $dado ["id_tec"]; ?> target="_blank"  role="button" aria-pressed="true"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
<?php } ?>
