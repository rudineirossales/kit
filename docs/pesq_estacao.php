      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
            ...
            <form class="form-inline" role="form"   method="POST" action="pesq_estacao.php" style="margin-left:10%;">
...
$sql = mysql_query ("select * from localidade join tecnico on localidade.matricula = tecnico.matricula where estacao like   '%$estacao%'" );
